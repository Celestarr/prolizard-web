...
import AppLogo from "busan/images/myfolab-icon-310x310.png";
...
const Header = ({
  ...
  return (
    <>
      <AppBar className="busan-app-bar" position="fixed">
        <Container sx={{ paddingX: 0 }}>
          <Toolbar className="busan-app-toolbar">
            <Link
              color="inherit"
              component={RouterLink}
              to="/"
            >
              <img alt="app-logo" className="busan-app-logo" src={AppLogo} />
            </Link>
            <Search>
              <SearchIconWrapper>
                <SearchIcon />
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              <Button
                className={classNames("busan-transparent-hover", "busan-no-text-transform")}
                size="large"
                edge="end"
